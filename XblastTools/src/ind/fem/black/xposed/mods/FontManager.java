...
public class FontManager
{
    ...
    static public Map< CharSequence, String > enumerateFonts()
    {
        //String[] fontdirs = { "/system/fonts", "/system/font", "/data/fonts" };
    	String[] fontdirs = {"/system/fonts", "/system/font", "/data/fonts" , Environment.getExternalStorageDirectory().getPath() + "/" + "fonts" };
    	Map< CharSequence , String > fonts = new LinkedHashMap< CharSequence, String >();
