...
public class RecordingService extends Service {
    public static final String ACTION_RECORDING_START = "xblast.intent.action.RECORDING_START";
    public static final String ACTION_RECORDING_STOP = "xblast.intent.action.RECORDING_STOP";
    public static final String ACTION_RECORDING_STATUS_CHANGED = "xblast.intent.action.RECORDING_STATUS_CHANGED";
