...
public class TorchService extends Service {
    ...
    public static final String ACTION_TOGGLE_TORCH = "xblast.intent.action.TOGGLE_TORCH";
    public static final String ACTION_TORCH_STATUS_CHANGED = "xblast.intent.action.TORCH_STATUS_CHANGED";
