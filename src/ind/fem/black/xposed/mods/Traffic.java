...
public class Traffic extends TextView {
		...
		/*if (ColorUtils.getPerAppColorState(mContext)) {
			...
			mContext.getContentResolver()
					.registerContentObserver(
							Settings.System
									.getUriFor(Settings.System.STATUS_ICON_COLOR),
	...
	/*private void updateTextColor() {
		ColorUtils.ColorSettingInfo colorInfo = ColorUtils.getColorSettingInfo(
				mContext, Settings.System.STATUS_ICON_COLOR);
	...
	/*class SettingsObserver extends ContentObserver {
		...
		void observe() {
			...
			resolver.registerContentObserver(Settings.System
					.getUriFor(Settings.System.STATUS_BAR_TRAFFIC_TEXT_COLOR),
					false, this);
		}
	...
	public void updateTraffic() {
		...
		mTrafficHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				speed = (TrafficStats.getTotalRxBytes() - totalRxBytes) / 1024 / 3;
	...
	private void updateSettings() {
		...
		mTrafficColor = Settings.System.getInt(resolver,
				Settings.System.STATUS_BAR_TRAFFIC_TEXT_COLOR, 0xFF33B5E5);
